...
// File: projects/lab8/include/ids.xml
`define IDS_SW_CTRL    4'h0
`define IDS_SW_ADDR    4'h1
`define IDS_DATA_CTRL  4'h2
`define IDS_DATA_HIGH  4'h3
`define IDS_DATA_LOW   4'h4
