...
//out_wr should be added FF to schronize memory
...
module ids_fifo 
   ...
   assign CPU_START    =  end_of_pkt;   //  this is the clk that all data is ready, and the input cpu_ctrl should be synounized
...
//       .mrst          (matcher_reset)         // reset in
   ...
   always @(*) begin
      ...
      case(state)
         ...
         CPU: begin
            end_of_pkt_next = 0;
            if (CPU_ctrl == 0 && CPU_START == 0 ) begin
               state_next = PULLBACK;
