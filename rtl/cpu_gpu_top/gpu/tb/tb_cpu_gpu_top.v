// tb_cpu_gpu_top.v
// Testbench for cpu_gpu_top (shared-DMEM wrapper around gpu_core) — STEP mode
...
module tb_cpu_gpu_top;
    ...
    // Write 64-bit word to DMEM via Port A
    task dmem_write;
        input [7:0]  addr;
        input [63:0] data;
        begin
    ...
    // Read DMEM via Port A and compare to expected value
    ...
    // -------------------------------------------------------
    initial begin
        $dumpfile("tb_cpu_gpu_top.vcd");
        $dumpvars(0, tb_cpu_gpu_top);
    end
