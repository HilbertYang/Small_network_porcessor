...
// ===========================================================================
  ...
  // J field extraction (inst[31:26]=6'b111011): inst[25:0]=target26
  ...
  localparam ALU_SHIFTLV = 4'b1000;   // shift left  by B[5:0] (variable)
  localparam ALU_SHIFTRV = 4'b1001;   // shift right by B[5:0] (variable)
  localparam ALU_SLT     = 4'b1010;   // set less than (signed)
...
// ===========================================================================
  ...
  // BEQ: take if Rn==Rm  --  ex_zero=1
  // BNE: take if Rn!=Rm  --  ex_zero=0
